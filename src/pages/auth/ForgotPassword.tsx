                ...
                <div className="relative z-10 p-12 text-white max-w-xl text-center">
                    ...
                    >
                        ...
                        <p className="text-lg text-slate-300 mb-8 leading-relaxed">
                            Recover your account password. Enter your registered email address and we'll send secure instructions to reset your password.
                        </p>
                        <div className="flex items-center justify-center space-x-6 text-sm font-medium text-slate-300">
                            <span className="flex items-center"><CheckCircle2 className="w-5 h-5 mr-2 text-[#e11d2d]" /> Secure Recovery</span>
                            <span className="flex items-center"><CheckCircle2 className="w-5 h-5 mr-2 text-[#e11d2d]" /> Auto-Expiration Links</span>
                        </div>
                    </motion.div>
                </div>
            </div>
                    ...
                    {success ? (
                        ...
                        >
                            ...
                            <p className="text-sm text-slate-600 dark:text-slate-400 mb-6 leading-relaxed">
                                We have sent a password reset link to <strong className="text-slate-950 dark:text-white font-semibold">{email}</strong>
                            </p>
                            <button
                                onClick={() => setSuccess(false)}
                                className="text-sm font-semibold text-[#e11d2d] hover:text-[#bf1124] dark:text-[#e11d2d] hover:underline transition-colors"
                            >
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            required
                                            className="block w-full pl-10 pr-3 py-3.5 border border-slate-200 dark:border-slate-700 rounded-xl bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm focus:ring-2 focus:ring-[#e11d2d] focus:border-transparent dark:text-white transition-all shadow-sm"
