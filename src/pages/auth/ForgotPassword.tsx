                ...
                <div className="relative z-10 p-12 text-white max-w-xl text-center">
                    ...
                    >
                        ...
                        <div className="flex items-center justify-center space-x-6 text-sm font-medium text-slate-300">
                            <span className="flex items-center"><CheckCircle2 className="w-5 h-5 mr-2 text-[#C8102E]" /> Secure Recovery</span>
                            <span className="flex items-center"><CheckCircle2 className="w-5 h-5 mr-2 text-[#C8102E]" /> Auto-Expiration Links</span>
                        </div>
                    </motion.div>
                </div>
            </div>
                    ...
                    {success ? (
                        ...
                        >
                            ...
                            <button
                                ...
                                className="text-sm font-semibold text-[#C8102E] hover:text-[#a00d24] dark:text-[#E31837] hover:underline transition-colors"
                            >
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            required
                                            className="block w-full pl-10 pr-3 py-3.5 border border-slate-200 dark:border-slate-700 rounded-xl bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm focus:ring-2 focus:ring-[#C8102E] focus:border-transparent dark:text-white transition-all shadow-sm"
