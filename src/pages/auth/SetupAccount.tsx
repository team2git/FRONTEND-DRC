    ...
    return (
        <div className="min-h-screen w-full flex bg-slate-50 dark:bg-slate-900 font-sans overflow-hidden">
                ...
                <div className="relative z-10 p-12 text-white max-w-xl text-center">
                    ...
                    >
                        ...
                        <p className="text-lg text-slate-300 mb-8 leading-relaxed">
                            Set up your credentials for the secure {portalName} portal. Standard accounts require verification for security and data privacy.
                        </p>
                        <div className="flex items-center justify-center space-x-6 text-sm font-medium text-slate-300">
                            <span className="flex items-center"><CheckCircle2 className="w-5 h-5 mr-2 text-[#e11d2d]" /> Password Setup</span>
                            <span className="flex items-center"><CheckCircle2 className="w-5 h-5 mr-2 text-[#e11d2d]" /> Instant Activation</span>
                        </div>
                    </motion.div>
                </div>
            </div>
            ...
            <div className="w-full lg:w-1/2 flex flex-col justify-between p-8 sm:p-12 md:p-16 relative">
                ...
                >
                    <div className="mb-6">
                        <Link to="/login" className="inline-flex items-center text-sm font-medium text-[#e11d2d] hover:text-[#bf1124] dark:text-[#e11d2d] hover:underline mb-4 transition-colors">
                            <ArrowLeft className="w-4 h-4 mr-2" />
                            Back to Login
                        </Link>
                        <h1 className="text-3xl font-bold text-slate-900 dark:text-white mb-2">Set Up Your Account</h1>
                        <p className="text-slate-500 dark:text-slate-400">Create a password to activate your account</p>
                    </div>
                    ...
                    {success ? (
                        ...
                        >
                            ...
                            <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-2">Account Setup Successful</h3>
                            <p className="text-sm text-slate-600 dark:text-slate-400 mb-6 leading-relaxed">
                                Your account is now active. You will be redirected to the login page shortly.
                            </p>
                            <Link 
                                to="/login" 
                                className="inline-flex items-center justify-center px-6 py-3 border border-transparent text-sm font-semibold rounded-xl text-white bg-[#e11d2d] hover:bg-[#bf1124] transition-all shadow-md"
                            >
                                Go to Login Now
                            </Link>
                        </motion.div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            required
                                            disabled={!token}
                                            className="block w-full pl-10 pr-10 py-3.5 border border-slate-200 dark:border-slate-700 rounded-xl bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm focus:ring-2 focus:ring-[#e11d2d] focus:border-transparent dark:text-white transition-all shadow-sm"
                                            placeholder="••••••••"
                                        />
                                        <button
                                            type="button"
                                    ...
                                    {loading ? (
                                        <div className="flex items-center">
                                            <svg className="animate-spin -ml-1 mr-3 h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                                ...
                                                <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.938l3-2.647z"></path>
                                            </svg>
                                            Setting up...
                                        </div>
                                    ) : (
