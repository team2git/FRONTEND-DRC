                ...
                <div className="relative z-10 p-12 text-white max-w-xl text-center">
                    ...
                    >
                        ...
                        <div className="flex items-center justify-center space-x-6 text-sm font-medium text-slate-300">
                            <span className="flex items-center"><CheckCircle2 className="w-5 h-5 mr-2 text-[#C8102E]" /> Password Setup</span>
                            <span className="flex items-center"><CheckCircle2 className="w-5 h-5 mr-2 text-[#C8102E]" /> Instant Activation</span>
                        </div>
                    </motion.div>
                </div>
            </div>
