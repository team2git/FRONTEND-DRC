...
export default function Home() {
  ...
  const usersOrgOptions: ApexOptions = {
    chart: { type: 'donut', fontFamily: 'Outfit, sans-serif' },
    colors: ['#C8102E', '#1E3A8A', '#0ea5e9', '#10b981', '#f59e0b', '#8b5cf6', '#ec4899'],
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 pb-4 border-b border-slate-100 dark:border-slate-800/60">
          <div>
            <h1 className="text-2xl font-black text-slate-900 dark:text-white tracking-tight flex items-center gap-2">
              <Shield className="w-6 h-6 text-[#C8102E] animate-pulse" />
              Dashboard
            </h1>
          ...
          <div className="flex items-center gap-3 w-full md:w-auto justify-between md:justify-end">
            ...
            <div className="flex p-1 bg-slate-100 dark:bg-slate-800/80 rounded-xl border border-slate-200/50 dark:border-slate-700/50 shadow-inner">
              {([
                ...
                .filter(tab => tab.key === 'drm' || isAdmin)
                .map(tab => {
            ...
            {isAdmin ? (
              <>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
                  ...
                  <div className="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03] p-5 shadow-sm">
                    ...
                    <div className="mt-2 grid grid-cols-3 gap-2 text-center">
                      {[
                        ...
                        { label: 'Submitted', val: stats?.woredaByStatus?.Submitted || 0, color: 'text-blue-600' },
                  ...
                  <div className="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03] p-5 shadow-sm">
                    ...
                    <div className="mt-2 grid grid-cols-3 gap-2 text-center">
                      {[
                        ...
                        { label: 'Published', val: stats?.templatesByStatus?.Published || 0, color: 'text-indigo-600' },
                  ...
                  <div className="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03] p-5 shadow-sm">
                    <h3 className="text-sm font-bold text-gray-800 dark:text-white/90 mb-1 flex items-center gap-2">
                      <BarChart3 className="size-4 text-blue-500" /> Mappings
                    </h3>
                    <p className="text-xs text-gray-400 mb-3">By publication status</p>
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 mb-4">
                      <div>
                        <h3 className="text-base font-bold text-gray-800 dark:text-white/90 flex items-center gap-2">
                          <MapIcon className="text-[#C8102E] size-5" /> GIS Risk Map — Addis Ababa Sub-Cities
                        </h3>
              ...
              <>
                {/* Non-Admin Layout: GIS Map + Woreda Profiles status donut side by side */}
                <div className="grid grid-cols-12 gap-6">
                  {/* GIS Map */}
                  <div className="col-span-12 lg:col-span-8 rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03] p-5 shadow-sm">
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 mb-4">
                  ...
                  {/* Woreda Profiles Status Donut Card in 4 columns */}
                  <div className="col-span-12 lg:col-span-4 rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03] p-5 shadow-sm flex flex-col justify-between">
                    <div>
                      <h3 className="text-sm font-bold text-gray-800 dark:text-white/90 mb-1 flex items-center gap-2">
                        <MapIcon className="size-4 text-red-500" /> Woreda Profiles
                      </h3>
        ...
        {activeTab === 'admin' && (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-5 gap-4">
              ...
              <StatCard label="Organizations" value={stats?.totalOrganizations || 0} icon={Building2} color="bg-blue-100 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400" />
              <StatCard label="Sectors" value={stats?.totalSectors || 0} icon={BarChart3} color="bg-indigo-100 dark:bg-indigo-900/20 text-indigo-600 dark:text-indigo-400" />
            ...
            {/* User context info */}
            <div className="rounded-2xl border border-blue-100 bg-blue-50 dark:border-blue-900/40 dark:bg-blue-900/10 p-5">
              ...
              <div className="grid grid-cols-2 md:grid-cols-5 gap-4 text-sm">
                {[
                  ...
                  <div key={item.label}>
                    <p className="text-blue-500 dark:text-blue-400 text-xs mb-0.5">{item.label}</p>
                    <p className="font-bold text-blue-900 dark:text-blue-200 capitalize">{item.value || 'N/A'}</p>
                  </div>
                ))}
              </div>
            </div>
